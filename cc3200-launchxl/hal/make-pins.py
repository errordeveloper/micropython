...
SUPPORTED_FN = {
    'GT'    : ['PWM00', 'PWM02', 'PWM03', 'PWM05', 'PWM06',
               'PWM07', 'CCP00', 'CCP01', 'CCP02', 'CCP03',
               'CCP04', 'CCP05', 'CCP06', 'CCP07'],
    'I2C'   : ['SDA', 'SCL'],
    'UART'  : ['RX', 'TX', 'CTS', 'RTS'],
    'GSPI'  : ['CS', 'CLK', 'MISO', 'MOSI']
}
...
class AlternateFunction(object):
    ...
    def ptr(self):
        """Returns the numbered function (i.e. UART0) for this AF."""
